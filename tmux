...
color_orange="colour16" # 208, 166
color_purple="colour5" # 135, 134
color_green="colour2" # 070
color_blue="colour4"
color_yellow="colour3"
color_red="colour1"
color_black="colour18"
...
google_calendar_status="#[fg=blue,bright]#{python /home/david/Scripts/agenda_reader.py}#[default]"
...
google_calendar_status="#[fg=blue,bright]#{python /home/david/Scripts/agenda_reader.py}#[default]"
#set-option -g status-right "$google_calendar_status"
